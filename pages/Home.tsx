    ...
    <div className="overflow-x-hidden pt-16 md:pt-20 bg-background-dark">
      ...
      <section className="relative min-h-[90vh] md:min-h-screen flex items-center overflow-hidden bg-navy-deep">
        ...
        <div className="absolute inset-0 z-0 pointer-events-none">
          ...
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_30%,rgba(255,193,7,0.05)_0%,transparent_60%)]"></div>
          ...
          <div className="absolute top-1/4 -right-20 w-[500px] h-[500px] bg-primary/10 blur-[150px] rounded-full animate-pulse"></div>
          <div className="absolute -bottom-20 -left-20 w-[600px] h-[600px] bg-primary/5 blur-[180px] rounded-full"></div>
        </div>
        ...
        <div className="relative z-10 px-6 w-full max-w-screen-xl mx-auto py-12 md:py-20 flex flex-col lg:flex-row items-center justify-between gap-20">
          <div className="max-w-5xl">
            <div className="inline-flex items-center gap-3 px-4 py-2 mb-10 rounded-full bg-white/5 border border-white/10 backdrop-blur-2xl animate-fade-in">
            ...
            <div className="overflow-hidden mb-10">
              <h1 className="text-6xl sm:text-7xl md:text-[9.5rem] font-display font-black leading-[0.82] tracking-tighter text-white uppercase animate-slide-up">
                Strategic <br/>
            ...
            <p className="text-xl md:text-3xl text-slate-300 mb-16 leading-relaxed font-light max-w-3xl text-balance animate-fade-in [animation-delay:400ms] opacity-0 [animation-fill-mode:forwards]">
              We find the elite leaders others miss. Bridging the gap between <span className="text-white font-medium">operational grit</span> and board-level strategy for the electrical sector.
            </p>
            
            <div className="flex flex-col sm:flex-row gap-6 animate-fade-in [animation-delay:600ms] opacity-0 [animation-fill-mode:forwards]">
              <Link to="/contact" className="bg-primary text-navy-deep px-14 py-7 rounded-sm font-bold text-[12px] uppercase tracking-[0.3em] shadow-[0_20px_50px_rgba(255,193,7,0.3)] hover:bg-white hover:shadow-primary/50 transition-all duration-500 flex items-center justify-center gap-4 group text-center">
          ...
          <div className="hidden lg:flex flex-col items-center animate-fade-in [animation-delay:800ms] opacity-0 [animation-fill-mode:forwards]">
             <div className="relative w-80 h-80 flex items-center justify-center">
                ...
                <div className="bg-navy-deep/80 backdrop-blur-3xl border-[3px] border-primary p-12 rounded-full shadow-[0_0_100px_rgba(255,193,7,0.15)] flex flex-col items-center text-center z-10 group hover:scale-105 transition-transform duration-700">
          ...
          <div className="max-w-screen-xl mx-auto">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-px bg-white/10 border border-white/10">
              {METRICS.map((metric, i) => (
                <div key={i} className="bg-background-dark p-10 md:p-14 text-center group hover:bg-navy-deep transition-all duration-700">
      ...
      <section id="services" className="py-32 md:py-48 px-6 bg-white text-slate-900 border-b border-slate-100">
        <div className="max-w-screen-xl mx-auto">
          <div className="text-center mb-24 md:mb-32">
            <span className="text-primary font-bold text-[11px] uppercase tracking-[0.5em] block mb-6">Our Core Methodology</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            {SERVICES.map((pillar, i) => (
              <div key={pillar.id} className="bg-slate-50 p-12 border border-slate-200 rounded-sm hover:bg-navy-deep hover:text-white transition-all duration-700 group flex flex-col min-h-[500px] shadow-sm hover:shadow-2xl overflow-hidden relative">
                <img 
                  src={pillar.image} 
                  alt={pillar.name} 
                  referrerPolicy="no-referrer"
                ...
                <div className="relative z-10 flex flex-col h-full">
                  <span className="text-primary font-bold text-4xl mb-8 opacity-40 group-hover:opacity-100">0{i+1}</span>
